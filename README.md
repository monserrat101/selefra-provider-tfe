# Selefra Provider TFE

Use this repo as a raw reference to **tables and schema** for Terraform cloud resources. [Here's](https://github.com/selefra/selefra-provider-tfe/blob/main/docs/tables/selefra-provider-tfe.md) a summary of full coverage.
